...
const FiltersMy = () => {
  ...
  return (
    <>
      <div className="bg-base-200 w-[100%] max-w-[800px]  mx-auto rounded-md px-8 py-4 grid gap-x-4 gap-y-8 sm:grid-cols-2 items-center ">
        <h1> {`category: ${inputValue || "best-sellers"}`} </h1>
        <h1>text={`${totalProducts} product${totalProducts > 1 && "s"}`}</h1>
      </div>
      <div className="bg-base-200 w-[100%] max-w-[800px] mx-auto rounded-md px-8 py-4 grid gap-x-4 gap-y-8 sm:grid-cols-2 ">
        <FormSelect
